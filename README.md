...
Computer Science undergraduate with a strong inclination toward building scalable applications and solving complex engineering problems.

I focus on engineering scalable systems and real-time applications that balance performance with user experience. I am particularly interested in the convergence of Machine Learning, backend engineering, and network-level analysis, where data, systems, and algorithms integrate to solve complex problems. I developed ZestBlog, a full-stack social blogging platform featuring real-time interactions, optimized data workflows, and a scalable architecture.

I prioritize writing clean, maintainable, and high-quality code, supported by strong problem-solving abilities and a solid foundation in core computer science concepts. I am continuously advancing my expertise in backend engineering, machine learning systems, and scalable system design, with the goal of contributing to impactful products and collaborative engineering environments.

## What I Do

- 🎓 Computer Science student focused on backend systems and scalable applications  
- 🚀 Built **ZestBlog**, a real-time full-stack social blogging platform  
- 💼 Currently working on **Jobrix** — a platform designed to align individual skills with real-world industry demands  
- 🤝 Open to collaborating on Machine Learning, cybersecurity, and backend projects  
- 🌱 Exploring advanced Machine Learning, system design, and distributed systems  
- 💬 Ask me about Python, DSA, backend engineering, and network analysis  
- ⚡ Passionate about transforming data and system behavior into meaningful insights  
...
<td width="300" height="180" valign="top">

### 🌐 Backend  
![Django](https://img.shields.io/badge/Django-14532D?style=for-the-badge&logo=django)
![Django Channels](https://img.shields.io/badge/Django%20Channels-14532D?style=for-the-badge)
